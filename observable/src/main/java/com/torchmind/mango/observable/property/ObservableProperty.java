...
public interface ObservableProperty<T> extends ObservableValue<T> {
        ...
        /**
         * Creates a bidirectional binding which allows modifications of this property to be forwarded to the bound
         * property value.
         *
         * @param property a reference to the property to bind to.
         * @return a reference to this property.
        ...
        /**
         * Checks whether this property is bound to another property's value and if so passes the property which governs
         * this property's value to the supplied consumer.
         *
